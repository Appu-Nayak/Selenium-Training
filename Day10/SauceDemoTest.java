package Assessments.Day10;
import Assessments.Day10.pom.CartPage;
import Assessments.Day10.pom.CheckoutPage;
import Assessments.Day10.pom.LoginPage;
import Assessments.Day10.pom.ProductsPage;
import Assessments.Day10.utilities.ExcelUtility;
import Assessments.Day10.utilities.PropertyUtility;
...
public class SauceDemoTest {
    ...
    public void setup() throws IOException {
        ChromeOptions options = new ChromeOptions(); //To handle that pop appears after login
    ...
    public void loginTest() throws IOException, InterruptedException {
        ...
        //Note:Instead of if-else we can Assert methods
...
//        System.out.println("Products page is displayed");
    ...
    // =========================
    @Test(dependsOnMethods = "loginTest")//If loginTest executes then this @Test executes
