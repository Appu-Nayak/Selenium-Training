package Assessments.Day8.PomImpementation;
import java.io.FileInputStream;
import java.io.IOException;
import java.time.Duration;
import java.util.Properties;

import Assessments.Day8.PomUtilities.OrangeHrmCandidatesPage;
import Assessments.Day8.PomUtilities.OrangeHrmHomepage;
import Assessments.Day8.PomUtilities.OrangeHrmLoginpage;
import Assessments.Day8.PomUtilities.OrangeHrmRecruitmentPage;
...
public class Day8_assessment {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        FileInputStream fis=new FileInputStream("src/test/java/Assessments/Day8/orangeHRM.properties");
        ...
        o1.getAddButton();
        FileInputStream file=new FileInputStream("src/test/java/Assessments/Day8/OrangeHrmRecruitmentpageData.xlsx");
